    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Add a category</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <form action="ajouter-server-post.php" method="post">
                <h5 id="text-add-produit">Name</h5>
    <input type="text" class="form-control" name="nom" placeholder=""required>
    <div class="space-input"></div>
    <h5 id="text-add-produit">IP</h5>
<input type="text" class="form-control" name="ip" placeholder="" required>
<div class="space-input"></div>
<h5 id="text-add-produit">Port</h5>
<input type="text" class="form-control" name="port" placeholder="" required>
<div class="space-input"></div>
<h5 id="text-add-produit">Max Players</h5>
<input type="text" class="form-control" name="max_players" placeholder="" required>
<div class="space-input"></div>
    <div class="space-input"></div>
<input type="submit" class="btn btn-secondary" value="Publish">
</form>
            </div>
        <div class="space"></div>
        </header>
